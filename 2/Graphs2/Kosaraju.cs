...
namespace Graphs2
{
    ...
    {
        public static void Dfs(Graphs_int graph, Vertex v, bool[] visited,HashSet<Vertex> newVisited)
        {
            visited[v] = true;
            newVisited.Add(v);
        ...
        public static void FillStack(Graphs_int graph, Vertex v, bool[] visited, Stack<Vertex> stack)
        {
            visited[v] = true;
            foreach (var item in graph.AdjacencyList(v))
            {
        ...
        public static List<HashSet<Vertex>> Kosaraju(this Graphs_int graph)
        {
        ...
        public static Graphs_int ReverseGraph(Graphs_int graph)
        {
