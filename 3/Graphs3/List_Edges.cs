...
namespace Graphs3
{
    ...
    internal class List_Edges : Graph_int
    {
        int max = 0;
        public List<(int, int, int)> graph = new List<(int, int, int)> { };
        public List_Edges(string path)
        {
        ...
        List<(int, int, int)> Graph_int.List_Of_Edges()
        {
            throw new NotImplementedException();
        }

        List<(int, int, int)> Graph_int.List_Of_Edges(int v)
        {
            throw new NotImplementedException();
        }
        ///Matrix_output
