...
namespace Graphs3
{
    ...
    {
        public static List<int> Not_Oriented_Vector_Of_Degrees(this Graph_int graph)
        {
        ...
        public static (List<int>, List<int>) Oriented_Vector_Of_Degrees(this Graph_int graph)
        {
