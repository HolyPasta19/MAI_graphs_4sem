...
namespace Graphs4
{
    ...
    {
        public static void Dfs(Graph_int graph, Vertex v, bool[] visited,HashSet<Vertex> newVisited)
        {
            visited[v] = true;
            newVisited.Add(v);
        ...
        public static void FillStack(Graph_int graph, Vertex v, bool[] visited, Stack<Vertex> stack)
        {
            visited[v] = true;
            foreach (var item in graph.AdjacencyList(v))
            {
        ...
        public static  List<HashSet<Vertex>> Kosaraju( Graph_int graph)
        {
        ...
        public static Graph_int ReverseGraph(this Graph_int graph)
        {
            ...
            return new Graph_Matrix(reversedMatrix);
