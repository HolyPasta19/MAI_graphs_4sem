...
namespace Graphs4
{
    ...
    {
        public static List<HashSet<Vertex>> IsConnectNotOriented(this Graph_int graph)
        {
        ...
        public static Graph_int GetOriented( Graph_int graph)
        {
            ...
            return new Graph_Matrix(orMatrix);
        }
